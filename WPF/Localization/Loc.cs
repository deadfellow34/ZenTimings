...
namespace ZenTimings.Localization
{
    ...
    public static class Loc
    {
            ...
            new Dictionary<string, string[]>(StringComparer.Ordinal)
        {
            ...
            { "Menu.StartLogging",      new[] { "Start _Logging",       "Kayd_ı Başlat" } },
            { "Menu.StopLogging",       new[] { "Stop _Logging",        "Kayd_ı Durdur" } },
            { "Menu.Help",              new[] { "_Help",                "_Yardım" } },
            { "Menu.OcProfiles",        new[] { "OC _Profiles",         "OC _Profilleri" } },
            ...
            { "Oc.TabProfiles",         new[] { "Profiles",             "Profiller" } },
